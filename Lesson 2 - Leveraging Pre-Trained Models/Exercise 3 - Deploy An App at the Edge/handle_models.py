...
def handle_car(output, input_shape):
    ...
    '''
    '''
    name: "color", shape: [1, 7, 1, 1] - Softmax output across 
    seven color classes [white, gray, yellow, red, green, blue, black]
    name: "type", shape: [1, 4, 1, 1] - Softmax output across four type classes [car, bus, truck, van]
    '''

    # TODO 1: Get the argmax of the "color" output
    
    color = output['color'].flatten()     # Get rid of unnecessary dimensions
    car_type = output['type'].flatten()   # Get rid of unnecessary dimensions
